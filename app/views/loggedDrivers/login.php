    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-body bg-light mt-5">
                ...
                <form action="<?php echo URLROOT; ?>/loggedDrivers/login" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="<?php echo URLROOT; ?>/loggedDrivers/login" class="btn btn-light btn-block">Login as manager</a>
                        </div>
                    </div>
                </form>
            </div>
